...
BINARY=../src/ni4462_capture

#Description: brief string for the start of the man page.
DESCRIPTION="simple, configurable data capture from the NI4462 card."

#Synopsis text, or leave blank to omit. Add leading spaces to avoid automatic paragraph formatting.
SYNOPSIS=`cat <<-EOT
 Capture data using the ni4462, reduce it, and print the analysis"
 Sampling modes are configurable: raw, CDSm, LinReg, Image, DifferentialImage
EOT`
...
SEE_ALSO=( "ni4462_test (1)" "arduino_delay (1)" "dat2cam (1)" )
